...
wai_illustrious_character_select_files = [       
    ...
    {'name': 'wai_character', 'file_path': os.path.join(json_folder, 'waiIllustriousSDXL_v160_characters.csv'), 'url':'https://raw.githubusercontent.com/mirabarukaso/character_select_stand_alone_app/refs/heads/main/data/waiIllustriousSDXL_v160_characters.csv'}
]
